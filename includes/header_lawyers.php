...
<header>
  <div id="header1">
    <nav>
      <ul>
        <button type="button" id="textHeader11" onclick="window.location.href='administration_add_lawyer.php'">Ajouter un avocat</button>
  ...
  <!-- <div id="ajoutAvocat" class="modal_bg">
    <div class="mod_content">
      <div class="mod_header">
        <h3>Ajouter un avocat</h3>
      </div>
      <div class="mod_main">
        <form method="post" action="sources/php/change_password.php" id="Astuce">
          <input required name="old" type="password" placeholder="Entrer votre mot de passe">
          <input required name="new" type="password" placeholder="Nouveau mot de passe">
          <input required name="again" type="password" placeholder="Confirmation Mot de passe">
        </form>
      </div>
      <div class="mod_footer">
        <button class="close_mod" data-modal="ajoutAvocat">Annuler</button>
        <h1 class="close_bar">|</h1>
        <input class="close_mod" type="submit" value="Valider" form="changePass">
      </div>
    </div>
  </div> -->
</header>
