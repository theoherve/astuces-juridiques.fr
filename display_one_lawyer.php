...
<html lang="fr"  dir="ltr">
      ...
      <?php header('Cache-Control: no cache'); ?>
		...
		<body id="my_lawyers">
				...
				<main id="main_display_one_lawyer">
            ...
            <div id="conteneur_conteneur">
              ...
              <div id="conteneur_conteneur_2">
                <div id="right_pres_lawyer">
                  ...
                  <div id="right_pres_lawyer_paypal">
                    ...
                    <div>
                      <a href="<?php echo $info['paypal'] ?>" target="_blank"><?php echo $info['paypal']?></a>
                    </div>
                  </div>
              ...
              <div id="main_pres_lawyer_mob">
                <div id="preview_lawyer_1">
                  ...
                  <div id="preview_lawyer_1_2_button">
                    <div id="display_one_lawyer_button_1" type="button" class="btn_modal" data-modal="RDVCabinet">
                      <button type="button" class="btn btn-primary btn-lg btn-block">Rendez-vous cabinet</button>
                    </div>
                    <div id="display_one_lawyer_button_2" type="button" class="btn_modal" data-modal="phoneCabinet">
                      <button type="button" class="btn btn-primary btn-lg btn-block">Rendez-vous cabinet</button>
                    </div>
                  </div>
                  </div>
